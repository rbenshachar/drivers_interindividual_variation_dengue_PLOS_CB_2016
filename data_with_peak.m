...
[~, params.p_time_PI_3, params.p_data_PI_3, params.p_LOD_PI_3] = viral_load_data_with_peak(3,1,1); 
...
[~, params.p_time_SI_DHF_2, params.p_data_SI_DHF_2, params.p_LOD_SI_DHF_2] = viral_load_data_with_peak(2,2,2);
[~, params.p_time_SI_DHF_3, params.p_data_SI_DHF_3, params.p_LOD_SI_DHF_3] = viral_load_data_with_peak(3,2,2);
...
params.p_time_PI = cat(1, params.p_time_PI_1, params.p_time_PI_2, params.p_time_PI_3);
params.p_data_PI = cat(1, params.p_data_PI_1, params.p_data_PI_2, params.p_data_PI_3);
params.p_LOD_PI = cat(1, params.p_LOD_PI_1, params.p_LOD_PI_2, params.p_LOD_PI_3);  

params.p_time_SI_DF = cat(1, params.p_time_SI_DF_1, params.p_time_SI_DF_2, params.p_time_SI_DF_3);
params.p_data_SI_DF = cat(1, params.p_data_SI_DF_1, params.p_data_SI_DF_2, params.p_data_SI_DF_3);  
params.p_LOD_SI_DF = cat(1, params.p_LOD_SI_DF_1, params.p_LOD_SI_DF_2, params.p_LOD_SI_DF_3); 

params.p_time_SI_DHF = cat(1, params.p_time_SI_DHF_1, params.p_time_SI_DHF_2, params.p_time_SI_DHF_3); 
params.p_data_SI_DHF = cat(1,params.p_data_SI_DHF_1, params.p_data_SI_DHF_2, params.p_data_SI_DHF_3); 
params.p_LOD_SI_DHF = cat(1, params.p_LOD_SI_DHF_1, params.p_LOD_SI_DHF_2, params.p_LOD_SI_DHF_3); 
